...
After the user approves and all work for the step/sub-substep is complete, always end the response with the git commands per `docs/step/policy_step.md §"Checklist: After Each Sub-substep"`:
