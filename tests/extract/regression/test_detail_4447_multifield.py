"""Strict multifield regression lock for detail_id=4447."""
...
def test_detail_4447_multifield_strict_snapshot() -> None:
    """detail_id=4447 must remain strict for all agreed fields."""
